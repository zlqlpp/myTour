...
public class JjsxCommon {
	...
	public static String commonsql(Object objstr) {
		String str = "";
		if (objstr == null || String.valueOf(objstr).equals("null") || String.valueOf(objstr).length() < 1) {
			str = "";
		}else{
			str = objstr.toString();
		}
	...
	public static String commonsql_inj(Object objstr) {
		String str = "";
		if (objstr == null || String.valueOf(objstr).equals("null") || String.valueOf(objstr).length() < 1) {
			str = "";
		}else{
