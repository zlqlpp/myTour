	...
	<head>
		...
		var bro=$.browser;
			...
			function ajaxQueryPage(pageNo){
				...
				var url = '${ctx}/disp/b07r02dispquery!querytjtdqwhtj.action';
			    var params = {
			...
			function addquerytable(data){
				...
				if(resultdata.length>0){
					for(var i=0;i<resultdata.length;i++){
						...
						tr+="<td valign=top align=left class=listtablebodyleft2  width=100>&nbsp;"+resultdata[i].DT_SJNO_CODE+"</td>";
						tr+="<td valign=top align=left class=listtablebodyleft1  width=100>&nbsp;"+resultdata[i].DM_SJ_CODE+"</td>";
						tr+="<td valign=top align=left class=listtablebodyleft2  width=120>&nbsp;"+resultdata[i].DM_SJNO_CODE+"</td>";
						tr+="</tr>";
									...
									<div id="tablelistdiv">
										<table class="listtable" width="900"
											...
											<thead>
												...
												<td align="left" class="listtableheadleft1" width="120">
													未维护集散机构量
												</td>
											</thead>
										</table>
