	...
	<head>
		...
		var bro=$.browser;
			...
			function ajaxQueryPage(pageNo){
				...
				var url = '${ctx}/disp/b07r02dispquery!querytjpwhrb.action';
			    var params = {
			...
			function addquerytable(data){
				...
				if(resultdata.length>1){
					...
					for(var i=0;i<resultdata.length;i++){
						...
						tr+="<td valign=top align=left class=selflisttablebodyleft1  width=100>"+resultdata[i].ADDR_SR_COUNT+"</td>";

						tr+="<td valign=top align=left class=selflisttablebodyleft1  width=100>"+resultdata[i].DRWH_COUNT+"</td>";
						...
						tr+="<td valign=top align=left class=selflisttablebodyleft1  width=100>"+vPG_SJ_CODELVQ+"%</td>";
						
						tr+="<td valign=top align=left class=selflisttablebodyleft1  width=100>"+resultdata[i].CRWH_COUNT+"</td>";
						tr+="<td valign=top align=left class=selflisttablebodyleft1  width=100>"+resultdata[i].ZRWH_COUNT+"</td>";
						tr+="<td valign=top align=left class=selflisttablebodyleft1  width=100>"+resultdata[i].QBWH_COUNT+"</td>";

						vPG_SJ_CODELVQB = 100;
						if(resultdata[i].ADDR_SR_COUNT > 0){
							vPG_SJ_CODELVQB = resultdata[i].QBWH_COUNT / parseInt(resultdata[i].ADDR_SR_COUNT);
							vPG_SJ_CODELVQB = Math.round ( vPG_SJ_CODELVQB * 10000 ) / 100;
						}
						tr+="<td valign=top align=left class=selflisttablebodyleft2  width=100>"+vPG_SJ_CODELVQB+"%</td>";
