	...
	<head>
		...
		<script type="text/javascript">
			...
			function ajaxAddUp(flag){
				...
				var tRSDNBLDG_IDTMP=$("#RSDNBLDG_IDTMP").val();
				...
				var params = {
						...
						RSDNBLDG_IDTMP:tRSDNBLDG_IDTMP,
						STRT_ID:tSTRT_ID,
						DIST_CD:tDIST_CD,
				...
				if(flag=='Add'){
					var url = '${ctx}/address/b04cud02addrconfig!addbldgrsdnsdius.action';
				}
					...
					<td valign="top" background="${ctx}/images/content-bg.gif">
						<table width="100%" height="31" border="0" cellpadding="0"
							...
							<tr>
								...
								<input id="RSDNBLDG_IDTMP" type="hidden" value="${bldgrsdnsBean.RSDNBLDG_ID}"/>
											...
											<tr id="tr_DORPLT_ID">
												...
												<td class="js_left_txt" id="td_DORPLT_ID" colspan="3">
													...
													<tr id="tdSTRT2_NAME">
														...
														<td class="js_left_txt" id="td_city_content" colspan="3">
															<input type="text" name="START_NUM" style="width: 200px; height:20px;" id="START_NUM" class="ac_input" size="300"  value="${bldgrsdnsBean.START_NUM}" onFocus="this.select();" onKeyUp="shNUM_FLAG('abbr')" onChange="shDTDMPG()"/><font color="#FF0000">&nbsp;(有门牌需要维护门牌)</font>
														</td>
													</tr>
