	...
	<head>
		...
		var bro=$.browser;
			...
			function ajaxQueryPage(pageNo){
				...
				document.getElementsByName("PK_REMARK")[0].checked = true;
			...
			function addquerytable(data){
				...
				if(resultdata.length>0){
					for(var i=0;i<resultdata.length;i++){
						...
						tr+="<td align=left class=listtablebodyleft1 style='width:100px'>&nbsp;"
						tr+="<a href='#' onClick=opentupian('" + resultdata[i].ITEMNO + "');>"+resultdata[i].ITEMNO+"</a>&nbsp;";
						tr+="</td>";
						...
						var vORG_NAME = resultdata[i].ORG_NAME
						if(vORG_NAME.length<3){
							vORG_NAME  = "查询不到的机构代码：" + resultdata[i].COLLECT_OFFICE
						}
						
						tr+="<td align=left class=listtablebodyleft1 style='width:100px'>&nbsp;"+vORG_NAME+"</td>";
						...
						var vPK_REMARK = resultdata[i].PK_REMARK
						if(vPK_REMARK == '2'){
							vPK_REMARK = '虚假或错误地址'
						}else if(vPK_REMARK == '3'){
							vPK_REMARK = '地址不完整或不规范'
						}else if(vPK_REMARK == '4'){
							vPK_REMARK = '地址与寄达地不符'
						}
						tr+="<td align=left class=listtablebodyleft1 style='width:100px'>&nbsp;"+vPK_REMARK+"</td>";
						tr+="<td align=left class=listtablebodyleft1 style='width:100px'>&nbsp;"+resultdata[i].INSERTTIME+"</td>";
						tr+="<td align=left class=listtablebodyleft2 style='width:100px'>&nbsp;"+resultdata[i].PK_TIME+"</td>";
						tr+="</tr>";
			...
			function uprgpqpd(){
				...
				var tPK_REMARK = "";
				var tPK_REMARK_radio=document.getElementsByName("PK_REMARK");
				for(var i=0;i<tPK_REMARK_radio.length;i++){
				   if(tPK_REMARK_radio[i].checked){
					   tPK_REMARK = tPK_REMARK_radio[i].value;
					}
				}
				...
				/*
				if(tPK_REMARK.length>1){
					tPK_REMARK.substr(0,1);
				}
				*/
			...
			function opentupian(titemno){
				var value = window.showModalDialog("${ctx}/address/b04cud01addrview!opentupian.action?FLAG=UPDATE&SEQID=" + titemno,"Code","dialogWidth:1200px;dialogHeight:500px;resizable=1,scrollbars=auto");				
				backfresh(value);
			}
		</script>
	</head>
					...
					<td valign="top" background="${ctx}/images/content-bg.gif">
						<table width="100%" height="31" border="0" cellpadding="0"
							...
							<tr>
								<td height="31">
									<div class="titlebt">
										进口局批区批段-直连南京<label onClick="gaoji()">.</label>
									</div>
								</td>
							</tr>
						</table>
						...
						<table>
							<tr>
								<td>
									<div id="querydiv">
										...
										<td class="listtablehead">
												...
												<td class="listtablehead" id="td_tpdistrict_content" colspan="3">
													...
													<input disabled type="radio" name="IS_YOUDIZHI" id="IS_YOUDIZHI" value="0">没有
												</td>
											</tr>
											<tr id="gaojitr3" style="display:none">
												...
												<td class="listtablehead" id="td_tpdistrict_content">
													...
													<input disabled type="radio" name="ISPOSTDISTTYPE" id="ISPOSTDISTTYPE" value="3">缺号
													<input disabled type="radio" name="ISPOSTDISTTYPE" id="ISPOSTDISTTYPE" value="2">无效地址
													<input disabled type="radio" name="ISPOSTDISTTYPE" id="ISPOSTDISTTYPE" value="1">其它
												</td>
												<td class="listtablehead">
													处理类型:
												</td>
												<td class="listtablehead" id="td_tpdistrict_content" colspan="3">
													...
													<input type="radio" name="ISWH" id="ISWH" value="1">已处理<br>
													<input type="radio" name="ISWH" id="ISWH" value="4">及时上传未处理
													<input type="radio" name="ISWH" id="ISWH" value="2">已处理达标
													<input type="radio" name="ISWH" id="ISWH" value="3">已处理未达标
												</td>
											</tr>
											<tr>
									...
									<div id="tablelistdiv">
										<table class="listtable" width="1700"
											id="address_table" cellpadding="0" cellspacing="0">
											<thead>
												<th align="left"  colspan="14">
													进口局批区批段
													&nbsp;&nbsp;&nbsp;&nbsp;
													<a href='#' onClick="opentupian('EU859939775CS');">&nbsp;详情单图片查看演示</a>
												</th>
											</thead>
											<thead>
												...
												<th align="left"  colspan="12">
													...
													<input type="radio" name="PK_REMARK" id="PK_REMARK" value="2">虚假或错误地址
													<input type="radio" name="PK_REMARK" id="PK_REMARK" value="3">地址不完整或不规范
													<input type="radio" name="PK_REMARK" id="PK_REMARK" value="4">地址与寄达地不符
...
<!--writing-mode:tb-rl;-->
										<table class="listtable" width="1700" id="address_table_list" cellpadding="0" cellspacing="0">
											
										</table>
										</div>

										<table class="listtable" width="1700" id="address_table_foot" cellpadding="0" cellspacing="0">
