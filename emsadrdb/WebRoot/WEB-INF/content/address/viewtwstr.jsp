	...
	<head>
		...
		var bro=$.browser;
			...
			function ajaxQueryPage(pageNo){
				...
				var url = '${ctx}/address/b04r02addrquery!querytwstr.action';
			    var params = {
			...
			function addquerytable(data){
				...
				if(resultdata.length>0){
					for(var i=0;i<resultdata.length;i++){
						...
						tr+="<td align=left class=listtablebodyleft1 width=75>&nbsp;<a href='#' onClick='viewtwStreetd("+ resultdata[i].DIST_CD + "," + '"' + resultdata[i].TOTAL_STREET_NAME + '"' + ");'>详细</a></td>";
						tr+="<td align=left class=listtablebodyleft1  width=250>&nbsp;"+resultdata[i].TOTAL_DISTRICT_NAME+"</td>";
			...
			function viewtwStreetd(tDIST_CD,tSTREET_NAME){
				var value = window.showModalDialog("${ctx}/address/b04r01addrview!viewtwstrd.action?FLAG=TW&DIST_CD=" + tDIST_CD + "&STREET_NAME=" + encodeURI(tSTREET_NAME),"Code","dialogWidth:600px;dialogHeight:500px;resizable=1,scrollbars=auto");				
				backfresh(value);
			}
									...
									<div id="tablelistdiv">
										<table class="listtable" width="900"
											...
											<thead>
												...
												<td align="left" class="listtableheadleft" width="250">
													行政区
												</td>
