	...
	<head>
		...
		var bro=$.browser;
			...
			function ajaxQueryPage(pageNo){
				...
				var url = '${ctx}/address/b04r02addrquery!querystreetsdium.action';
			    var params = {
			...
			function addquerytable(data){
				...
				if(resultdata.length>0){
					for(var i=0;i<resultdata.length;i++){
						...
						tr+="<td align=left class=listtablebodyleft1  width=200>&nbsp;"+resultdata[i].TOTAL_DIUMENPAI+"</td>";				
						...
						tr+=" <a href='#' onClick='viewBo(" + resultdata[i].DIST_CD + "," + resultdata[i].STRT_ID  + "," + '"' + resultdata[i].TOTAL_DISTRICT_NAME + '"' + "," + '"' + resultdata[i].TOTAL_STREET_NAME + '"' + "," + '"' + resultdata[i].TOTAL_DIUMENPAI + '"' + ");'>小区&机构</a></td>";	
						tr+="</tr>";
			...
			function viewBo(tDIST_CD,tSTRT_ID,tTOTAL_DISTRICT_NAME,tTOTAL_STREET_NAME,tTOTAL_DIUMENPAI){
				var value = window.showModalDialog("${ctx}/address/b04r01addrview!viewbos.action?DIST_CD="+ tDIST_CD + "&STRT_ID=" + tSTRT_ID + "&TOTAL_DISTRICT_NAME=" + encodeURI(tTOTAL_DISTRICT_NAME) + "&TOTAL_STREET_NAME=" + encodeURI(tTOTAL_STREET_NAME) + "&TOTAL_DIUMENPAI=" + encodeURI(tTOTAL_DIUMENPAI),"Code","dialogWidth:950px;dialogHeight:600px;resizable=1,scrollbars=auto");
			}
		</script>
	</head>
	<body>
