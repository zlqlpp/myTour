											...
											<tr>
												<td class="listtablehead"  colspan="4">
													<font id="fliphelpcon" color="red">
														*机构代码可以多条查询例如 输入括号中的机构代码，以,分割【1100000,120000】
														<br>*操作步骤 点击【可配置】选择【机构代码】到【选择频次】中即可
														<br>*点击【已配置】可以维护已经配置的信息
													</font>
												</td>
											</tr>
										</table>
