...
function getUsWebRuleGJ(rulLevel){
		var RulUsWebRuleGJ = true;
		if(rulLevel=='0' || rulLevel=='2'){
			RulUsWebRuleGJ = true;
		}else if(rulLevel=='5' || rulLevel=='10' || rulLevel=='15' || rulLevel=='20' || rulLevel=='25'){
			RulUsWebRuleGJ = false;
		}
		return RulUsWebRuleGJ;
	}
